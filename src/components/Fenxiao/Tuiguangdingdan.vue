    ...
    <div class="nav2">
      ...
      <div class="myTable">
        <vxe-table :data="tableData">
          <vxe-table-column field="order_no" title="订单号"></vxe-table-column>
          ...
          <vxe-table-column field="goods_count" title="商品数量"></vxe-table-column>
          <vxe-table-column field="goods_price" title="商品价格"></vxe-table-column>
          <vxe-table-column field="mobile" title="手机号"></vxe-table-column>
          <vxe-table-column field="pay_amount" title="总支付"></vxe-table-column>
...
export default {
  ...
  methods: {
    async getData() {
      const res = await this.$api.recommendorders_list({
      ...
      this.tableData.forEach(ele => {
        ele.myHierarchy_types =
          ele.hierarchy_types == "1"
            ? "一级"
            : ele.hierarchy_types == "2"
            ? "二级"
            : "居间";
      });
    },
