    ...
    <div class="nav3">
      ...
      <div class="myTable">
        <vxe-table :loading="loading" :data="tableData">
          ...
          <vxe-table-column field="card_no" title="银行卡卡号"></vxe-table-column>
          ...
          <!-- <vxe-table-column field="myBuy_way" title="支付状态"></vxe-table-column> -->
            ...
            <template slot-scope="scope">
              <div class="flex">
                <!-- <el-button
                  ...
                  type="text"
                >发货</el-button>-->
                <el-button size="small" :disabled="scope.row.is_status != 0" @click="tongguo(scope.row)" type="text">通过</el-button>
                <el-button size="small" :disabled="scope.row.is_status != 0" @click="jujue(scope.row)" type="text">拒绝</el-button>
...
export default {
  ...
  methods: {
    ...
    async tongguo(row) {
      const res = await this.$api.withdrawal_setstatus({
        id: row.id,
        status: 1
      });
